...
import DateSelect from '@/components/default-components/date-select'
import DropdownFull from '@/components/default-components/dropdown-full'
import DropdownFilter from '@/components/default-components/dropdown-filter'
import DropdownProfile from '@/components/default-components/dropdown-profile'
import DropdownSwitch from '@/components/default-components/dropdown-switch'
import DropdownNotifications from '@/components/default-components/dropdown-notifications'
import DropdownHelp from '@/components/default-components/dropdown-help'
import EditMenu from '@/components/default-components/edit-menu'
        ...
        <div>
          ...
          <div className="space-y-8 mt-8 mb-80">
            ...
            <div>
              ...
              <DropdownProfile userName="John Doe" avatar="/path/to/avatar.jpg" />
            </div>
            ...
            <div>
              ...
              <DropdownNotifications userId="12345" />
            </div>
