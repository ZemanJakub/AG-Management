    ...
    return (
      <div className="flex items-center gap-4 overflow-auto px-[6px] py-[4px]">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-4">
            <Input
              ...
              classNames={{
                label: "text-white",
                //behind the input
                inputWrapper: ["bg-gray-200 dark:bg-gray-800"],
                innerWrapper: [
                  "bg-gray-200 dark:bg-gray-800",
                  "focus-within:bg-gray-200 dark:focus-within:bg-gray-800",
                  "focus:bg-gray-200 dark:focus:bg-gray-800", // Konzistence během focus-within
                ],
                input: [
            ...
            <div>
              <Popover placement="bottom">
                ...
                <PopoverContent className="w-80 bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
            ...
            <div>
              <Dropdown
                classNames={{
                  ...
                  content:
                    "p-0 border-small border-divider bg-gray-200 dark:bg-gray-800",
                }}
              >
                <DropdownTrigger>
                  <Button
          ...
          <Divider
            className="h-5 border-gray-200 dark:border-gray-700"
            orientation="vertical"
          />
          <div className="whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
            {filterSelectedKeys === "all"
              ? "Vybráno vše"
              : `${filterSelectedKeys.size} Vybráno`}
          </div>
          {(filterSelectedKeys === "all" || filterSelectedKeys.size > 0) && (
            ...
            >
              <DropdownTrigger>
                <Button
                  className="border-gray-200 dark:border-gray-700 text-default-800"
                  endContent={
    ...
    return (
      <div className="mb-[18px] flex items-center justify-between">
        <div className="flex w-full max-w-[300px] items-center gap-2">
          <h1 className="text-2xl font-[700] leading-[32px] truncate">
            Přijímací proces
          </h1>
          <Chip
      ...
      <div className="flex flex-col items-center justify-between gap-2 px-2 py-2 sm:flex-row">
        <Pagination
          ...
          classNames={{
            ...
            next: "bg-transparent",
            cursor:
              "bg-gradient-to-b  from-secondary-300 to-secondary-600 dark:from-secondary-300 dark:to-secondary-100 text-white font-bold",
          }}
        />
        <div className="flex items-center justify-end gap-6 ">
          <span className="text-small text-default-400 ">
            {filterSelectedKeys === "all"
              ? "Vybráno vše"
              : `${filterSelectedKeys.size} z ${filteredItems.length} vybráno`}
          </span>
          <div className="flex items-center gap-3">
            <Button
              isDisabled={page === 1}
  ...
  return (
    <div className="h-full w-full p-6">
      ...
      <Table
        ...
        classNames={{
          // table: "border-collapse border border-gray-300 dark:border-gray-700", // Rámeček tabulky
          th: "dark:bg-gray-800 dark:text-gray-100 font-semibold px-4 py-3 ", // Hlavička tabulky
          td: "dark:bg-gray-800 dark:text-gray-200 px-4 py-2 before:bg-transparent ", // Hlavička tabulkyBuňky tabulky
          tr: "border-b border-gray-200 dark:border-gray-700 dark:hover:bg-gray-800",
          // Řádky tabulky
