            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-[96rem] mx-auto">
              ...
              <div className="max-w-2xl m-auto mt-16">
                ...
                <div className="text-center px-4">
                  ...
                  <div className="mb-6">Hmm...stránku se nepodařilo nalézt.... </div>
                  <Link href="/" className="btn bg-indigo-500 hover:bg-indigo-600 text-white">Zpět na úvodní stránku</Link>
                </div>
