...
import SearchModal from "@/components/default-components/search-modal";
...
export default function Header({ userName, userId, variant, avatar }: HeaderProps) {
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <DropdownProfile align="right" userName={userName} avatar={avatar}/>
